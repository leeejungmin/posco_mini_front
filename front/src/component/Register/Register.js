...
const Register = () => {
    ...
    const onSubmitLogin = async (e) => {
        ...
        if (user.userId === '') {
            ...
            if (user.password.length < 8) openAlert('비밀번호를 8자리 이상 입력해주세요');
            return;
                            ...
                            <div className="max-w-2xl mx-auto bg-white p-16">
                                <div>
                                    <div className="grid gap-6 mb-6 lg:grid-cols-2">
                                        ...
                                        <div></div>
                                        <div>
                                            <div for="company" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                이름
                                            </div>
                                            <input
                                                type="text"
                                    ...
                                    <div className="flex items-start mb-6">
                                        ...
                                        <div for="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-400">
                                            회원가입을 위한 위 정보 제공에 동의합니다.
                                        </div>
                                    </div>
                                    <br></br>
                                    <br></br>
