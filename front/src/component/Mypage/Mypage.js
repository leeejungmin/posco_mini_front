...
const Mypage = () => {
  ...
  // useEffect(() => {
  //  setCount(countReview());
   
  //  }, [userDetail]);

  const getUserlist = async (e) => {
   
    await dispatch(getUserById(userDetail.myId));
        ...
        <div className=" flex-wrap select-none rounded-md  p-4 transition duration-500 ease-in-out transform hover:-translate-y-2 rounded-2xl border-2 p-6 mt-3 border-mainYellow hover:shadow-2xl">
          <form className="flex-auto p-6 ">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="text-lg font-semibold text-slate-500">{count}</div>
            </div>
            ...
            <div className="flex flex-wrap">
              ...
              <div className="text-lg font-semibold text-slate-500">{userInfo.userId}</div>
            </div>
            <div className="flex flex-wrap">
              <h1 className="flex-auto text-lg font-semibold text-slate-900">
                이름
              </h1>
              <div className="text-lg font-semibold text-slate-500">{userInfo.name}</div>
            </div>
            <div className="flex flex-wrap">
              <h1 className="flex-auto text-lg font-semibold text-slate-900">
                폰번호
              </h1>
              <div className="text-lg font-semibold text-slate-500">{userInfo.phoneNum}</div>
            </div>
