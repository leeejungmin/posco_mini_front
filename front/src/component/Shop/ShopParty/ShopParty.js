                                ...
                                <div className="bg-white p-4 rounded-md">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div className="flex justify-between bg-gradient-to-tr from-amber-500 to-amber-300 rounded-md py-2 px-4 text-stone-700 font-bold text-md">
                                                    <div>
                                                        <span>숯불애　　　　</span>
                                                    </div>
                                                    <div>
