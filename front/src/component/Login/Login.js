        ...
        <>
            ...
            <div className="bg-gray-400">
                <div className="container mx-auto">
                            ...
                            <div className="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                                ...
                                <div className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                                    <Form onSubmit={onSubmit}>
                                        <div className="mb-4">
                                            <div className="font-sans-kr block mb-2 text-sm font-bold text-gray-700">아이디</div>
                                            <input
                                        ...
                                        <div className="mb-4">
                                            <div className="font-sans-kr block mb-2 text-sm font-bold text-gray-700">비밀번호</div>
                                            <input
                                    ...
                                    <div className="flex justify-center">
                                        <img className="animate-bounce" src="/img/pointer.png"></img>
                                    </div>
                    ...
                    <br></br>
                    <div className="flex justify-center">
                        <p>Copyright 2021.같이 먹어요.All Right Reserved.</p>
                    </div>
                </div>
            </div>
        </>
